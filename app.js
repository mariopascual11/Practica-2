...
const baseURLs = {
hello: "http://localhost:8001/api/hello",
json: "http://localhost:8001/api/json",
csv: "http://localhost:8001/api/csv",
};
...
if (filename && content) {
// Si es CSV, validar que el contenido tenga al menos una línea con datos
